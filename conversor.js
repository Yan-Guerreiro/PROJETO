...
// COTACOES DO DIA 21/11/2022 13:00
let valorDoDolar   = 5.3677
let valorDoEuro    = 5.4374
let valorDaLibra   = 6.2733
let valorDoBitcoin = 83478.14
let valorEmReal    = 0
...
function mensagemFormatada(moedaConvertida) {
    ...
    aviso.textContent = "" + (valorEmReal).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) + " Em " + moedaEstrangeira + " é " + moedaConvertida
}
...
btnLimpar.addEventListener('click', function() {
    valorDigitado.focus()
    valorDigitado.value = ''
    aviso.textContent = 'DIGITE, ESCOLHA E CONVERTA'
